...
public class SelectTool extends AbstractMouseTool {
  ...
  public void mousePressed(MouseEvent var1) {
    ...
    if (this.diagram.getSelectedState() == null) {
      if (var6 != null) {
        ...
        var10.setLocation((int)(var6.getControlPoint().getX() - HANDLE_DIMENSION.getWidth() / 2.0D), (int)(var6.getControlPoint().getY() - HANDLE_DIMENSION.getHeight() / 2.0D));
        if (var1.getClickCount() > 1) {
          TransitionFrame var12 = new TransitionFrame(this.diagram.getCurrentMachine(), var6);
          ...
          if (var12.getTransition() != null) {
            ...
            JOptionPane.showMessageDialog(this.diagram, "Transitions reading the left end marker can only\ngo right.", "Invalid Transition", 0, (Icon)null);
          }
        }
  ...
  public void mouseReleased(MouseEvent var1) {
    ...
    if (var3 != null) {
      double var5 = this.diagram.toUser(var2).getX() - this.diagram.toUser(this.lastPoint).getX();
      double var7 = this.diagram.toUser(var2).getY() - this.diagram.toUser(this.lastPoint).getY();
      ...
      for(int var12 = 0; var12 < var11.size(); ++var12) {
        ...
        if (var13.getCurrentState().equals(var3.getName()) && var13.getCurrentState().equals(var13.getNextState())) {
  ...
  private void moveHandle(Point var1) {
    ...
    var7.setLocation((int)(var2.getControlPoint().getX() - HANDLE_DIMENSION.getWidth() / 2.0D), (int)(var2.getControlPoint().getY() - HANDLE_DIMENSION.getHeight() / 2.0D));
  ...
  public void mouseDragged(MouseEvent var1) {
    ...
    if (var3 != null) {
      ...
      for(int var11 = 0; var11 < var10.size(); ++var11) {
        ...
        if (var12.getCurrentState().equals(var3.getName()) && var12.getCurrentState().equals(var12.getNextState())) {
  ...
  public void postDraw(Graphics2D var1) {
    ...
    if (var2 != null) {
      ...
      java.awt.geom.Ellipse2D.Double var4 = new java.awt.geom.Ellipse2D.Double((double)((int)var3.getX()) - HANDLE_DIMENSION.getWidth() / 2.0D, (double)((int)var3.getY()) - HANDLE_DIMENSION.getHeight() / 2.0D, HANDLE_DIMENSION.getWidth(), HANDLE_DIMENSION.getHeight());
