    ...
    public void preDraw(Graphics2D var1) {
        if (this.currentTransition != null) {
            ...
            if (this.currentTransition
                    .getCurrentState()
                    .equals(this.currentTransition.getNextState())) {
                CubicCurve2D var8 =
                        (CubicCurve2D) this.diagram.getGraphicEdge(this.currentTransition);
                var2 =
                ...
                QuadCurve2D var9 =
                        (QuadCurve2D) this.diagram.getGraphicEdge(this.currentTransition);
                var2 =
