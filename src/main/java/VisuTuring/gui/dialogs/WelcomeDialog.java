...
public class WelcomeDialog extends VTDialog {
  ...
  public WelcomeDialog(Frame var1) {
    ...
    JButton var5 = new JButton(this.createImageIcon("/res/buttons/openButton.gif"));
    var5.setRolloverEnabled(true);
    var5.setBorderPainted(false);
    var5.setRolloverIcon(this.createImageIcon("/res/buttons/openButton_o.gif"));
    var5.setPressedIcon(this.createImageIcon("/res/buttons/openButton_s.gif"));
    var5.setFocusPainted(false);
    var5.setContentAreaFilled(false);
    var5.setCursor(new Cursor(12));
    var4.add(var5);
    JButton var6 = new JButton(this.createImageIcon("/res/buttons/createButton.gif"));
    var6.setRolloverEnabled(true);
    var6.setBorderPainted(false);
    var6.setRolloverIcon(this.createImageIcon("/res/buttons/createButton_o.gif"));
    var6.setPressedIcon(this.createImageIcon("/res/buttons/createButton_s.gif"));
